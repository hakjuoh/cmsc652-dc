        ...
        implements BlockCipher
{
            ...
            CipherParameters  params)
    {
        if (params instanceof KeyParameter)
        {
            ...
            logger.debug("Key   : " + new String(Hex.encode(((KeyParameter)params).getKey())));
...
//        };
    ...
    protected void desFunc(
            ...
            int     outOff)
    {
        logger.debug("Input : " + new String(Hex.encode(out)));

        int     work, right, left;

        logger.debug("    Initial Permutation");
        ...
        logger.debug("    Left  : " + new String(Hex.encode(ByteBuffer.allocate(4).putInt(left).array())) + "    Right : " + new String(Hex.encode(ByteBuffer.allocate(4).putInt(right).array())));

        for (int round = 0; round < 8; round++)
        {
            logger.debug("    Round " + ((round * 2) + 1));
            int     fval;
        ...
        logger.debug("    Final Permutation");
        ...
        logger.debug("Output: " + new String(Hex.encode(out)));
    }
}
